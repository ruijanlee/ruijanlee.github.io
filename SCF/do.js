...
var mm = md5(document.getElementById('input').value);
...
function do6(argument) {
	// document.getElementById('output').value = document.getElementById('input').value
	let t6 = document.getElementById('input').value

	t6 = md5(t6)
	t6 = t6.toUpperCase()	
	t6 = pwd6(t6)

	document.getElementById('output').value = t6
}

function do14(argument) {
	let t14 = document.getElementById('input').value

	t14 = md5(t14)
	t14 = t14.toUpperCase()	
	t14 = pwd14(t14)

	document.getElementById('output').value = t14
}
